...
def sp_main(data):
    ...
    info_what_happened = Information(left=p_what_happened_var, rtype=RType.IS, rtense=Tense.PRESENT, right=p_what_happened)
    info_when_happened = Information(left=p_when_happened_var, rtype=RType.IS, rtense=Tense.PAST, right=p_when_happened)
    info_is_first_time = Information(left=p_is_first_time_var, rtype=RType.IS, rtense=Tense.PRESENT, right=p_is_first_time)
    info_has_contact_lenses = Information(left=p_has_contact_lenses_var, rtype=RType.IS, rtense=Tense.PRESENT, right=p_has_contact_lenses)
    info_did_self_cure = Information(left=p_did_self_cure_var, rtype=RType.IS, rtense=Tense.PRESENT, right=p_did_self_cure)
    info_did_take_drugs = Information(left=p_did_take_drugs_var, rtype=RType.IS, rtense=Tense.PRESENT, right=p_did_take_drugs)
    info_has_allergy = Information(left=p_has_allergy_var, rtype=RType.IS, rtense=Tense.PRESENT, right=p_has_allergy)
    info_has_rheumatic_disease = Information(left=p_has_rheumatic_disease_var, rtype=RType.IS, rtense=Tense.PRESENT, right=p_has_rheumatic_disease)
    info_does_relatives_have_it = Information(left=p_does_relatives_have_it_var, rtype=RType.IS, rtense=Tense.PRESENT, right=p_does_relatives_have_it)
    ...
    utterances = [
        ...
        Utterance(text='So, what brings you here today?', actions=[
            RequestInfo(asked=Information(left=p_what_happened_var, rtype=RType.IS, rtense=Tense.PRESENT, right=AnyProperty()))
        ]),
        ...
        Utterance(text='When did it happen?', actions=[
            RequestInfo(asked=Information(left=p_when_happened_var, rtype=RType.IS, rtense=Tense.PAST, right=AnyProperty()))
        ]),
        ...
        Utterance(text='Did you have this problem before?', actions=[
            RequestInfo(asked=Information(left=p_is_first_time_var, rtype=RType.IS, rtense=Tense.PRESENT, right=AnyProperty()))
        ]),
        ...
        Utterance(text='Do you wear contact lenses?', actions=[
            RequestInfo(asked=Information(left=p_has_contact_lenses_var, rtype=RType.IS, rtense=Tense.PRESENT, right=AnyProperty()))
        ]),
        ...
        Utterance(text='Did you try to cure it yourself?', actions=[
            RequestInfo(asked=Information(left=p_did_self_cure_var, rtype=RType.IS, rtense=Tense.PRESENT, right=AnyProperty()))
        ]),
        ...
        Utterance(text='Did you take any drugs for your eye?', actions=[
            RequestInfo(asked=Information(left=p_did_take_drugs_var, rtype=RType.IS, rtense=Tense.PRESENT, right=AnyProperty()))
        ]),
        Utterance(text=p_did_take_drugs.name, actions=[
            Share(information=info_did_take_drugs)
        ]),
        Utterance(text='Do you have any allergies?', actions=[
            RequestInfo(asked=Information(left=p_has_allergy_var, rtype=RType.IS, rtense=Tense.PRESENT, right=AnyProperty()))
        ]),
        Utterance(text=p_has_allergy.name, actions=[
            Share(information=info_has_allergy)
        ]),
        Utterance(text='Do you have any rheumatic diseases?', actions=[
            RequestInfo(asked=Information(left=p_has_rheumatic_disease_var, rtype=RType.IS, rtense=Tense.PRESENT, right=AnyProperty()))
        ]),
        Utterance(text=p_did_self_cure.name, actions=[
            Share(information=info_did_self_cure)
        ]),
        Utterance(text='Do your relatives have it?', actions=[
            RequestInfo(asked=Information(left=p_does_relatives_have_it_var, rtype=RType.IS, rtense=Tense.PRESENT, right=AnyProperty()))
        ]),
        Utterance(text=p_did_self_cure.name, actions=[
            Share(information=info_did_self_cure)
        ]),
