...
from socialds.operations.delete_relation_from_rsholder import DeleteRelationFromRSHolder
...
class UnfeelEmotion(Effect):
    ...
    def equals_with_pronouns(self, other, pronouns):
        if not isinstance(other, UnfeelEmotion):
            return False
