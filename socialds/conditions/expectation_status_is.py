...
class ExpectationStatusIs(Condition):
    def __init__(self, expectation: Expectation, expectation_status: ExpectationStatus,
    ...
    def __repr__(self):
        return "Expectation status for the expectation %s is %s" % (
        self.expectation.name, self.expectation_status.value)
